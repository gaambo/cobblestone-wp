...
require_once 'includes/job-post-type.php';
...
class Theme extends Site
{
    ...
    /**
     * Registers custom post types (CPTs) and custom taxonomies for the theme.
     *
    ...
    public function registerJobPostType()
    {
        ...
        Job_Post_Type\register_taxonomy();
    }

...
namespace Obsidian\CoreFunctionality;
...
add_filter('http_request_args', '\\Obsidian\\CoreFunctionality\\dontUpdatePlugin', 5, 2);
...
add_action('tgmpa_register', '\\Obsidian\\CoreFunctionality\\registerRequiredPlugins');
